...
cp /home/ec2-user/pract_shell/expense_project/backend.service /etc/systemd/system/backend.service &>>$log_file_name
...
mysql -h 172.31.94.20 -uroot -pExpenseApp@1 < /app/schema/backend.sql &>>$log_file_name
